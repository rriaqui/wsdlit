...
/**
 * Casos de proba para o filtrador de versións para STAGE
 *
 * @author rriaqui
 * @since 1.0.0
 */
public class StageVersionFilterTestCase {
    @Test
    public void sameEnvironmentVersionsTest() {
        final List<Version> versions = Arrays.asList(
                ...
                new TestVersion( "1.9.0-rc2" )
        );
        final String expected = "2.1.0-rc0";
        final List<Version> filteredVersions = versions
                .stream()
                .filter( new VersionFilter( VersionType.STAGE ) )
    ...
    public void onBottomTest() {
        ...
        final String expected = "2.0.0-rc0";
        final List<Version> filteredVersions = versions
                .stream()
                .filter( new VersionFilter( VersionType.STAGE ) )
                .collect( Collectors.toList() );
