 ...
 * @since 1.0.0
 */
public class AdvancedFollowedTestCase {
    ...
    public void itemZeroTest() {
        final Artifact itemArtifact = candidates.get( 0 );
        final Artifact expectedArtifact = new DefaultArtifact(
                "gal.xunta.amtega.wsdlit.maven.plugin",
                "myV2CA",
                "zip",
                "[,2.0.0)"
        );
        Assert.assertEquals( AssertMessages.EQUALS_EXPECTED, expectedArtifact, itemArtifact );
    }

    @Test
    public void itemOneTest() {
        final Artifact itemArtifact = candidates.get( 1 );
        final Artifact expectedArtifact = new DefaultArtifact(
                "gal.xunta.amtega.wsdlit.maven.plugin",
                "myV1CA",
                "zip",
