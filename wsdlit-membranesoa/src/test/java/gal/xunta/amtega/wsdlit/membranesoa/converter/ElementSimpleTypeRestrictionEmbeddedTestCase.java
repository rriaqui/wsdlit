...
public class ElementSimpleTypeRestrictionEmbeddedTestCase
extends ElementTestCaseAbstract {
	@Test
	...
	public void getTypeTestTest() {
		Assert.assertEquals( AssertMessages.EQUALS_EXPECTED, "xsd:string", this.node.getType() );
	}

	@Test
	public void noChildrenTest() {
		Assert.assertTrue( AssertMessages.TRUE_EXPECTED, this.node.getChildren().isEmpty() );
	}
}
