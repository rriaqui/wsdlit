 ...
 */
public class MessagePartElementChangedTestCase
extends AbstractTestCase {
    ...
    @Test
    public void getReducedDifferencesSizeTest() {
        final List<Difference> differences = diffTool.getEssentialDifferences(  getInputStreamV1(), getInputStreamV2()  );
        final int changesCount = 2;

        Assert.assertEquals( AssertMessages.SIZE_NOT_EXPECTED, changesCount, differences.size() );
    }
}
