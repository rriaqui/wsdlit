 ...
 * @since 1.0.0
 */
public class SEIEmptyTestCase {
    private static final String SERVICE = StringUtil.EMPTY;
    private static final String INTERFACE = StringUtil.EMPTY;
    private static final String ENDPOINT = StringUtil.EMPTY;
